...
namespace Norm.Mapper
{
    ...
    {
        internal static IEnumerable<T> Map<T>(this IEnumerable<ReadOnlyMemory<(string name, object value, bool set)>> tuples,
            Type type1)
        {
        ...
        internal static IEnumerable<(T1, T2)> Map<T1, T2>(this IEnumerable<ReadOnlyMemory<(string name, object value, bool set)>> tuples,
            Type type1,
            Type type2)
        {
        ...
        internal static IEnumerable<(T1, T2, T3)> Map<T1, T2, T3>(this IEnumerable<ReadOnlyMemory<(string name, object value, bool set)>> tuples,
            Type type1,
            Type type2,
            Type type3)
        {
        ...
        internal static IEnumerable<(T1, T2, T3, T4)> Map<T1, T2, T3, T4>(this IEnumerable<ReadOnlyMemory<(string name, object value, bool set)>> tuples,
            Type type1,
            Type type2,
            Type type3,
            Type type4)
        ...
        internal static IEnumerable<(T1, T2, T3, T4, T5)> Map<T1, T2, T3, T4, T5>(this IEnumerable<ReadOnlyMemory<(string name, object value, bool set)>> tuples,
            Type type1,
            Type type2,
            Type type3,
            Type type4,
        ...
        internal static IEnumerable<(T1, T2, T3, T4, T5, T6)> Map<T1, T2, T3, T4, T5, T6>(this IEnumerable<ReadOnlyMemory<(string name, object value, bool set)>> tuples,
            Type type1,
            Type type2,
            Type type3,
            Type type4,
        ...
        internal static IEnumerable<(T1, T2, T3, T4, T5, T6, T7)> Map<T1, T2, T3, T4, T5, T6, T7>(this IEnumerable<ReadOnlyMemory<(string name, object value, bool set)>> tuples,
            Type type1,
            Type type2,
            Type type3,
            Type type4,
        ...
        internal static IEnumerable<(T1, T2, T3, T4, T5, T6, T7, T8)> Map<T1, T2, T3, T4, T5, T6, T7, T8>(this IEnumerable<ReadOnlyMemory<(string name, object value, bool set)>> tuples,
            Type type1,
            Type type2,
            Type type3,
            Type type4,
        ...
        internal static IEnumerable<(T1, T2, T3, T4, T5, T6, T7, T8, T9)> Map<T1, T2, T3, T4, T5, T6, T7, T8, T9>(this IEnumerable<ReadOnlyMemory<(string name, object value, bool set)>> tuples,
            Type type1,
            Type type2,
            Type type3,
            Type type4,
        ...
        internal static IEnumerable<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10)> Map<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(this IEnumerable<ReadOnlyMemory<(string name, object value, bool set)>> tuples,
            Type type1,
            Type type2,
            Type type3,
            Type type4,
        ...
        internal static IEnumerable<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11)> Map<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(this IEnumerable<ReadOnlyMemory<(string name, object value, bool set)>> tuples,
            Type type1,
            Type type2,
            Type type3,
            Type type4,
        ...
        internal static IEnumerable<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12)> Map<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(this IEnumerable<ReadOnlyMemory<(string name, object value, bool set)>> tuples,
            Type type1,
            Type type2,
            Type type3,
            Type type4,
