    ...
    public static partial class NormExtensions
    {
            ...
            Type type1)
        {
            ...
            foreach (var t in tuples)
            {
                ...
                t.MapInstance(ref t1, ref descriptor, ref delegates, 0);
                yield return t1;
            }
        }

        public static IEnumerable<(T1, T2)> Map<T1, T2>(this IEnumerable<(string name, object value)[]> tuples, 
            Type type1, 
            Type type2)
        {
            ...
            foreach (var t in tuples)
            {
                ...
                t.MapInstance(ref t1, ref descriptor, ref delegates1, 0);
                t.MapInstance(ref t2, ref descriptor, ref delegates2, 1);
                yield return (t1, t2);
            }
        }

        public static IEnumerable<(T1, T2, T3)> Map<T1, T2, T3>(this IEnumerable<(string name, object value)[]> tuples,
            Type type1, 
            Type type2, 
            Type type3)
        {
            ...
            foreach (var t in tuples)
            {
                ...
                t.MapInstance(ref t1, ref descriptor, ref delegates1, 0);
                t.MapInstance(ref t2, ref descriptor, ref delegates2, 1);
                t.MapInstance(ref t3, ref descriptor, ref delegates3, 2);
                yield return (t1, t2, t3);
            }
        }

        public static IEnumerable<(T1, T2, T3, T4)> Map<T1, T2, T3, T4>(this IEnumerable<(string name, object value)[]> tuples,
            Type type1, 
            Type type2, 
            Type type3, 
            Type type4)
        {
            ...
            foreach (var t in tuples)
            {
                ...
                t.MapInstance(ref t2, ref descriptor, ref delegates2, 1);
                t.MapInstance(ref t3, ref descriptor, ref delegates3, 2);
                t.MapInstance(ref t4, ref descriptor, ref delegates4, 3);
                yield return (t1, t2, t3, t4);
            }
        }

        public static IEnumerable<(T1, T2, T3, T4, T5)> Map<T1, T2, T3, T4, T5>(this IEnumerable<(string name, object value)[]> tuples,
            Type type1, 
            Type type2, 
            Type type3, 
            Type type4, 
            Type type5)
        {
            ...
            foreach (var t in tuples)
            {
                ...
                t.MapInstance(ref t3, ref descriptor, ref delegates3, 2);
                t.MapInstance(ref t4, ref descriptor, ref delegates4, 3);
                t.MapInstance(ref t5, ref descriptor, ref delegates5, 4);
                yield return (t1, t2, t3, t4, t5);
            }
        }

        public static IEnumerable<(T1, T2, T3, T4, T5, T6)> Map<T1, T2, T3, T4, T5, T6>(this IEnumerable<(string name, object value)[]> tuples,
            Type type1,
            Type type2,
            Type type3,
            Type type4,
            ...
            Type type6)
        {
            ...
            foreach (var t in tuples)
            {
                ...
                t.MapInstance(ref t4, ref descriptor, ref delegates4, 3);
                t.MapInstance(ref t5, ref descriptor, ref delegates5, 4);
                t.MapInstance(ref t6, ref descriptor, ref delegates6, 5);
                yield return (t1, t2, t3, t4, t5, t6);
            }
        }

        public static IEnumerable<(T1, T2, T3, T4, T5, T6, T7)> Map<T1, T2, T3, T4, T5, T6, T7>(this IEnumerable<(string name, object value)[]> tuples,
            Type type1,
            Type type2,
            Type type3,
            Type type4,
            ...
            Type type7)
        {
            ...
            foreach (var t in tuples)
            {
                ...
                t.MapInstance(ref t5, ref descriptor, ref delegates5, 4);
                t.MapInstance(ref t6, ref descriptor, ref delegates6, 5);
                t.MapInstance(ref t7, ref descriptor, ref delegates7, 6);
                yield return (t1, t2, t3, t4, t5, t6, t7);
            }
        }

        public static IEnumerable<(T1, T2, T3, T4, T5, T6, T7, T8)> Map<T1, T2, T3, T4, T5, T6, T7, T8>(this IEnumerable<(string name, object value)[]> tuples,
            Type type1,
            Type type2,
            Type type3,
            Type type4,
            ...
            Type type8)
        {
            ...
            foreach (var t in tuples)
            {
                ...
                t.MapInstance(ref t6, ref descriptor, ref delegates6, 5);
                t.MapInstance(ref t7, ref descriptor, ref delegates7, 6);
                t.MapInstance(ref t8, ref descriptor, ref delegates8, 7);
                yield return (t1, t2, t3, t4, t5, t6, t7, t8);
            }
        }

        public static IEnumerable<(T1, T2, T3, T4, T5, T6, T7, T8, T9)> Map<T1, T2, T3, T4, T5, T6, T7, T8, T9>(this IEnumerable<(string name, object value)[]> tuples,
            Type type1,
            Type type2,
            Type type3,
            Type type4,
            ...
            Type type9)
        {
            ...
            foreach (var t in tuples)
            {
                ...
                t.MapInstance(ref t7, ref descriptor, ref delegates7, 6);
                t.MapInstance(ref t8, ref descriptor, ref delegates8, 7);
                t.MapInstance(ref t9, ref descriptor, ref delegates9, 8);
                yield return (t1, t2, t3, t4, t5, t6, t7, t8, t9);
            }
        }

        public static IEnumerable<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10)> Map<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(this IEnumerable<(string name, object value)[]> tuples,
            Type type1,
            Type type2,
            Type type3,
            Type type4,
...
;
            ...
            foreach (var t in tuples)
            {
                ...
                t.MapInstance(ref t8, ref descriptor, ref delegates8, 7);
                t.MapInstance(ref t9, ref descriptor, ref delegates9, 8);
                t.MapInstance(ref t10, ref descriptor, ref delegates10, 9);
                yield return (t1, t2, t3, t4, t5, t6, t7, t8, t9, t10);
            }
        }

        public static IEnumerable<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11)> Map<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>(this IEnumerable<(string name, object value)[]> tuples,
            Type type1,
            Type type2,
            Type type3,
            Type type4,
            ...
            Type type11)
        {
            ...
            foreach (var t in tuples)
            {
                ...
                t.MapInstance(ref t9, ref descriptor, ref delegates9, 8);
                t.MapInstance(ref t10, ref descriptor, ref delegates10, 9);
                t.MapInstance(ref t11, ref descriptor, ref delegates11, 10);
                yield return (t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11);
            }
        }

        public static IEnumerable<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12)> Map<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>(this IEnumerable<(string name, object value)[]> tuples,
            Type type1,
            Type type2,
            Type type3,
            Type type4,
            ...
            Type type12)
        {
            ...
            foreach (var t in tuples)
            {
                ...
                t.MapInstance(ref t10, ref descriptor, ref delegates10, 9);
                t.MapInstance(ref t11, ref descriptor, ref delegates11, 10);
                t.MapInstance(ref t12, ref descriptor, ref delegates12, 11);
