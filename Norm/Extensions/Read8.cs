...
namespace Norm
{
    public static partial class NormExtensions
    {
        ...
        {
            return connection.GetNoOrmInstance().Read<T1, T2, T3, T4, T5, T6, T7, T8>(command, readerCallback);
        }
        ...
        public static IEnumerable<(T1, T2, T3, T4, T5, T6, T7, T8)> ReadFormat<T1, T2, T3, T4, T5, T6, T7, T8>(this DbConnection connection, 
            ...
            Func<(string Name, int Ordinal, DbDataReader Reader), object> readerCallback)
        {
            return connection.GetNoOrmInstance().ReadFormat<T1, T2, T3, T4, T5, T6, T7, T8>(command, readerCallback);
        }
        ...
        ///<returns>IEnumerable enumerator of eight value tuples (T1, T2, T3, T4, T5, T6, T7, T8).</returns>
        public static IEnumerable<(T1, T2, T3, T4, T5, T6, T7, T8)> Read<T1, T2, T3, T4, T5, T6, T7, T8>(this DbConnection connection, string command, object parameters)
        {
        ...
        public static IEnumerable<(T1, T2, T3, T4, T5, T6, T7, T8)> Read<T1, T2, T3, T4, T5, T6, T7, T8>(this DbConnection connection, 
            ...
            object parameters)
        {
            return connection.GetNoOrmInstance().Read<T1, T2, T3, T4, T5, T6, T7, T8>(command, readerCallback, parameters);
        }
    }
}