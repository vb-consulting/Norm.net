...
namespace Norm
{
    public static partial class NormExtensions
    {
        ...
        {
            return connection.GetNoOrmInstance().ReadAsync<T1, T2, T3, T4, T5, T6>(command, readerCallback);
        }
        ...
        public static IAsyncEnumerable<(T1, T2, T3, T4, T5, T6)> ReadFormatAsync<T1, T2, T3, T4, T5, T6>(this DbConnection connection, 
            ...
            Func<(string Name, int Ordinal, DbDataReader Reader), object> readerCallback)
        {
            return connection.GetNoOrmInstance().ReadFormatAsync<T1, T2, T3, T4, T5, T6>(command, readerCallback);
        }
        ...
        ///<returns>IAsyncEnumerable async enumerator of six value tuples (T1, T2, T3, T4, T5, T6).</returns>
        public static IAsyncEnumerable<(T1, T2, T3, T4, T5, T6)> ReadAsync<T1, T2, T3, T4, T5, T6>(this DbConnection connection, string command, object parameters)
        {
        ...
        public static IAsyncEnumerable<(T1, T2, T3, T4, T5, T6)> ReadAsync<T1, T2, T3, T4, T5, T6>(this DbConnection connection, 
            ...
            object parameters)
        {
            return connection.GetNoOrmInstance().ReadAsync<T1, T2, T3, T4, T5, T6>(command, readerCallback, parameters);
        }
    }
}