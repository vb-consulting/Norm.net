...
namespace Norm
{
    public static partial class NormExtensions
    {
        ...
        {
            return connection.GetNoOrmInstance().Read<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(command, readerCallback);
        }
        ...
        public static IEnumerable<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10)> ReadFormat<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(this DbConnection connection, 
            ...
            Func<(string Name, int Ordinal, DbDataReader Reader), object> readerCallback)
        {
            return connection.GetNoOrmInstance().ReadFormat<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(command, readerCallback);
        }
        ...
        ///<returns>IEnumerable enumerator of ten value tuples (T1, T2, T3, T4, T5, T6, T7, T8, T9, T10).</returns>
        public static IEnumerable<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10)> Read<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(this DbConnection connection, string command, object parameters)
        {
        ...
        public static IEnumerable<(T1, T2, T3, T4, T5, T6, T7, T8, T9, T10)> Read<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(this DbConnection connection, 
            ...
            object parameters)
        {
            return connection.GetNoOrmInstance().Read<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(command, readerCallback, parameters);
        }
    }
}