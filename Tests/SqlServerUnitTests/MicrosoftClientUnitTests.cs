...
{
    [Collection("MicrosoftSqlClientDatabase")]
    public class MicrosoftClientUnitTests
    {
        private readonly MicrosoftSqlClientFixture fixture;
        ...
        public MicrosoftClientUnitTests(MicrosoftSqlClientFixture fixture)
        {
