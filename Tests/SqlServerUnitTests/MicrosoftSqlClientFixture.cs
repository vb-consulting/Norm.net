...
{
    [CollectionDefinition("MicrosoftSqlClientDatabase")]
    public class MicrosoftDatabaseFixtureCollection : ICollectionFixture<MicrosoftSqlClientFixture> { }

    public class MicrosoftSqlClientFixture : IDisposable
    {
        private readonly TestConfig.TestConfig config;

        public string ConnectionString { get; }

        public MicrosoftSqlClientFixture()
        {
